...
main:
    ...
    main_inicio:    
      ...
      call CheckPlayerPoliceCollision ; <--- ADICIONE ESTA LINHA
...
MoveComDirAnterior:
    ...
    ; ROTAÇÃO V -> H (Vindo de Cima ou Baixo?)
    load r4, tecla_ant
    loadn r2, #'w'
    cmp r4, r2
    jeq Ajuste_V_para_H_Esq
    loadn r2, #'s'
    cmp r4, r2
    jeq Ajuste_V_para_H_Esq
    jmp DefineSpriteEsq
...
Ajuste_V_para_H_Esq:
    dec r0 ; Curva Fechada: Compensa o +1 da vertical
...
ChecaCima: 
    ...
    ; ROTAÇÃO H -> V (Vindo da Direita ou Esquerda?)
    load r4, tecla_ant 
    loadn r2, #'d'
    cmp r4, r2
    jeq Ajuste_H_para_V_Cima
    loadn r2, #'a'
    cmp r4, r2
    jeq Ajuste_H_para_V_Cima
    jmp MovimentoCima

Ajuste_H_para_V_Cima:
    inc r0 ; Centraliza o carro (de 3px para 2px)
...
ChecaBaixo: 
    ...
    loadn r2, #'d'
    cmp r4, r2
    jeq Ajuste_H_para_V_Baixo
    loadn r2, #'a'
    cmp r4, r2
    jeq Ajuste_H_para_V_Baixo
    jmp MovimentoBaixo

Ajuste_H_para_V_Baixo:
    inc r0 ; Centraliza o carro
...
ChecaDireita: 
    ...
    ; ROTAÇÃO V -> H (Vindo de Cima ou Baixo?)
    ; AQUI ESTÁ A SUA LÓGICA DE "CURVA FECHADA"
    load r4, tecla_ant
    loadn r2, #'w'
    cmp r4, r2
    jeq Ajuste_V_para_H_Dir
    loadn r2, #'s'
    cmp r4, r2
    jeq Ajuste_V_para_H_Dir
    jmp DefineSpriteDir
...
Ajuste_V_para_H_Dir:
    dec r0 ; Curva Fechada: Puxa 1 pixel para trás para não bater na parede externa

DefineSpriteDir:
    loadn r5, #ladrao_R
    loadn r6, #ladraoGaps_H
    ; jmp FazChecagem (cai direto)
...
; --- 4. CHECAGEM DE COLISÃO E LIMITES ---
    ...
    loadn r1, #1
    cmp r7, r1              
    jeq MovimentoConfirmado ; Se válido, vai direto                        
