...
policia : var #7
  static policia + #0, #3081 ;  yellow_00
  static policia + #1, #3082 ;  yellow_01
  static policia + #2, #3083 ;  yellow_02
  ;38  espacos para o proximo caractere
  static policia + #3, #3084 ;  yellow_10
  static policia + #4, #3085 ;  yellow_11
  static policia + #5, #3086 ;  yellow_12
