...
eat_loop:
    ...
    ; Remove a cor para checar se é item
    push r5              ; Salva endereço
    mov r5, r7           ; Move ID para r5 para chamar a função
    call GetBaseID       ; r5 agora é o ID Base
    mov r7, r5           ; Devolve para r7
    pop r5               ; Recupera endereço
...
Comer:
    ...
    loadn r6, #31            ; Caractere de espaço vazio
    ;load r5, r8
    storei r5, r6
...
Policia_checkCenario:
    ...
    loadn r1, #MapBuffer ;Carrega o endereço do mapa
