...
# Sounds
deleteSong = pygame.mixer.Sound("songs/explosion_dull.wav")
generateScreenSong = pygame.mixer.Sound("songs/sd_0.wav")
clickSong = pygame.mixer.Sound("songs/click.wav")
generateCharmapSong = pygame.mixer.Sound("songs/shimmer_1.wav")
importSong = pygame.mixer.Sound("songs/import.wav")
personaSong = pygame.mixer.Sound("songs/completetask_0.wav")
